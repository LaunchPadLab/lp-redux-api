import { compose, set, unset, deprecate } from './utils'
...
function setFromRequest (requestKey, path) {
...
export default deprecate(setFromRequest, 'Use setOnSuccess() or setOnFailure() instead.')