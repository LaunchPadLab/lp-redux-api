...
Statuses are stored for all requests with a `requestKey` (including those created by [requestWithKey][32]),
...
-   `requestKey` **[String][41]** A unique key that you can use to reference your request in [setFromRequest][37] or [selectStatus][46]
...
A function that creates action handlers for actions generated by [requestWithKey][32].
...
-   `requestKey` **[String][41]** A unique key that references a request created by [requestWithKey][32]
